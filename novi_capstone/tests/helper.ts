...
import { IDL } from "../target/types/swap_to_sol";//TODO get the IDL for USDC
import {
  PublicKey,
  Keypair,
  Connection,
...
export const NOVI = anchor.workspace.NoviCapstone as Program<NoviCapstone>;
...
export const program = new Program(IDL as anchor.Idl, NOVI.programId, provider);
...
const findProgramWSOLAccount = (): PublicKey => {
  return PublicKey.findProgramAddressSync([Buffer.from("wsol")], NOVI.programId)[0];
};
